...
class ecsOrderSettings
{
    ...
    public function displayOrderExpSettings(
        $Cron,
        $Path,
        $Shipping,
        $Status,
...
';
        echo '<div class="form-group">
                <label class="col-md-4 control-label" for="giftcard_attribute">Attribute code of Gift Card Message</label>
                    <div class="col-md-4">
                    <input id="textinput" name="giftcard_attribute" type="text" placeholder="gift_message"  class="form-control input-md" value=' .
            $giftMessage .
            '>
        ...
        echo '<div class="form-group">
                <label class="col-md-4 control-label" for="giftcard_attribute_value">Attribute code value to show gift card input</label>
                    <div class="col-md-4">
                    <input id="textinput" name="giftcard_attribute_value" type="text" placeholder="Yes"  class="form-control input-md" value=' .
            $giftMessageValue .
            '>
