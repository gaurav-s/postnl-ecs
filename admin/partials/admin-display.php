...
function postnlecs_admin_scripts($hook) {
    ...
    //wp_die($hook);
    if ($hook == 'woocommerce_page_fulfillment_ECS') {
...
function postnlecs_Addaction() {
	...
	$pw_settings_page = add_submenu_page( 'woocommerce', 'PostNL Fulfilment', 'PostNL Fulfilment', 'manage_options', 'fulfillment_ECS', 'postnlecs_Addpage' ); 
...
add_action('manage_shop_order_posts_custom_column', 'postnlecs_add_exportedColumn', 10, 2);
